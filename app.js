...
mongoose.connect("mongodb+srv://todolist:hassan@cluster0.hyrjb.mongodb.net/todolist?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true });
const itemSchema = {
    name: String
}
